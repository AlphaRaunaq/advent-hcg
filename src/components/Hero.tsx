        ...
        <div className="grid lg:grid-cols-2 gap-16 items-end min-h-[460px]">
          ...
          <div className="py-20 flex flex-col gap-7">
            ...
            <h1 className="font-serif text-5xl lg:text-6xl font-bold text-white leading-[1.08] tracking-tighter">
              Redefining<br />
              <em className="not-italic text-accent font-normal italic">healthcare</em><br />
              delivery.
            </h1>

            <p className="text-[15px] text-white/60 leading-relaxed font-light max-w-md">
              Advent was established in 2003 by a small and thoughtful team who were intrigued
              by the projected challenges and opportunities in healthcare in India in the coming years.
            </p>
