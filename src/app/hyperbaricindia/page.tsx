      ...
      <section className="bg-white py-20 px-6 lg:px-12 border-b border-rule">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-[200px_1fr] gap-16">
          ...
          <div className="space-y-4 text-[18px] text-ink-2 leading-relaxed font-light">
            <p>
              Hyperbaric Oxygen Therapy is an internationally established
              treatment modality with well defined "evidence based" indications,
              which can significantly reduce patient's morbidity and mortality
              and reduce overall cost of medical treatment. It is rapidly
              growing worldwide because of the benefits to patients, doctors,
              institutions and financial outcomes.
            </p>
            <p>
              Apollo Hospital Delhi took the lead by establishing the first
              hyperbaric treatment center in the private sector in May 2000.
              This center is the first Hyperbaric Center in a private hospital
              and with the growing opportunity to expand this service; it has
              been set up in Apollo Hospital, Ahmadabad.
            </p>
            <p>
              We have a wide multi-specialty patient base and additional
              patients from outside the institution. It has provided an
              adjunctive treatment option for better outcomes in difficult cases
              for existing patients within the hospital.
            </p>
            <p>
              Our center gives the institution great recognition and prominence
              nationally and internationally joining the elite group of modern
              hospitals with this service. The number of patients has been
              progressively growing confirming its professional and financial
              acceptability and viability.
            </p>

            <a
              href="http://hyperbaricindia.com"
              target="_blank"
